...
![Punchcardgrafiek: een raster van dagen (maandag tot zondag) per uur (00:00-23:00), met de grootste bollen op zaterdagnamiddag en -avond, wanneer de meeste oplossingen werden ingediend](./course-statistics-punchcard-nl.png)
...
![Heatmapgrafiek: een kalender voor één academiejaar met maandlabels, waarbij de dagen met de meeste ingediende oplossingen duidelijk donkerdere vierkantjes hebben](./course-statistics-heatmap-nl.png)
...
![Vioolgrafiek "Aantal oplossingen per gebruiker" met één vorm per oefening op de as "Aantal ingediende oplossingen" en een bolletje voor het gemiddeld aantal pogingen per oefening](./series-graph-violin-nl.png)
...
![Staafdiagram "Verdeling van de oplossingsstatus" met één balk per oefening, opgedeeld in correct, fout, compilatiefout en andere statussen, met een legende onder de balken](./series-graph-stacked-status-nl.png)
...
![Grafiek "Ingediende oplossingen over tijd" met de velden Startdatum en Einddatum erboven, één rij gekleurde vierkantjes per oefening, en een legende voor de intervalgrootte onder de grafiek](./series-graph-timeseries-nl.png)
...
![Grafiek "Gebruikers met minstens één correcte oplossing" met een stijgende lijn per oefening op een percentageschaal en een legende eronder](./series-graph-cumulative-timeseries-nl.png)
...
![Kolom Voortgang groep in de oefeningentabel, met een balkje per oefening: grijs voor het gestarte aandeel en gekleurd voor het correct opgeloste aandeel](./class-progress-bar-nl.png)
