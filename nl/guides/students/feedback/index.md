...
| `Geheugenlimiet overschreden` | ![Geheugenlimiet overschreden](../../../../images/submission-status-icons/memory-limit-exceeded.png) | geheugenlimiet vastgelegd voor de oefening werd overschreden tijdens het uitvoeren van minstens één test; je krijgt deze status ook wanneer je oplossing te traag werd om op tijd klaar te zijn omdat het geheugen op was |
