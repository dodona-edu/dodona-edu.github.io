...
Deze handleidingen bevatten alles wat je nodig hebt om Dodona als student te gebruiken, van het aanmaken van een account tot het interpreteren van de feedback op je oplossingen.

Ben je nieuw op Dodona? Volg dan de handleidingen in deze volgorde:

1. [Van start met Dodona](./getting-started/): wat Dodona is en hoe je ons kan contacteren.
2. [Aanmelden & gebruikersinstellingen](./login-and-settings/): een gebruikersaccount aanmaken en personaliseren.
