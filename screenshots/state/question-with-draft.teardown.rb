...
# :llm_response, dependent: :destroy) seeded on Submission 557 by
# question-with-draft.setup.rb. Idempotent: submission 557's id is a stable seeded
...
submission = Submission.find(557)
destroyed = submission.annotations.where(type: 'Question').destroy_all
Rails.cache.clear

puts "question-with-draft: destroyed #{destroyed.size} Question(s) (+ dependent LlmResponse) on Submission 557"
