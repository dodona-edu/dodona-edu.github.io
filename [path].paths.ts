...
const redirects = internationalizedRedirects({
    ...
    'guides/teachers/new-exercise-repo': 'guides/exercises/creating-exercises/setup',
    'guides/exercises/new-exercise-repo': 'guides/exercises/creating-exercises/setup',
