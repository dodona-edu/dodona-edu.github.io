...
- **A `description` directory**: this directory contains the files describing the exercise containing:
  - **A `description.<lang>.md` file** (e.g., `description.en.md`, `description.nl.md`, `description.fr.md`): these files contain the description of the exercise for each language, identified by a [two-letter language code](https://en.wikipedia.org/wiki/List_of_ISO_639_language_codes).
