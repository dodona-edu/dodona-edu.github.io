...
This `oracle_context` is an object of type `ConvertedOracleContext` from the module `evaluation_utils`. Objects of this type contain the following attributes:
