...
These guides cover everything you need to use Dodona as a student, from creating an account to interpreting the feedback on your solutions.

If you are new to Dodona, follow the guides in this order:

1. [Getting Started](./getting-started/): what Dodona is and how to contact us.
2. [Signing Up & User Settings](./login-and-settings/): create a user account and personalize it.
