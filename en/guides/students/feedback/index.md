...
| `Memory limit exceeded` | ![Memory limit exceeded](../../../../images/submission-status-icons/memory-limit-exceeded.png) | Memory limit for the exercise was exceeded during the execution of at least one test. You also get this status when your solution became too slow to finish in time because it ran out of memory. |
