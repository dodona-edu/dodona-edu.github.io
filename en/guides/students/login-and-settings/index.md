...
If no one from your school has signed up for Dodona before, things might not go as expected. To sign up, we use the existing accounts from your educational institution and link them using techniques such as [SAML](https://en.wikipedia.org/wiki/Security_Assertion_Markup_Language) and [OAuth](https://en.wikipedia.org/wiki/OAuth). Sometimes, this process fails because your school has not given permission for this link. If your school signs in with Microsoft, pass [Allowing Dodona in Microsoft Entra ID](/en/guides/microsoft-entra/) on to their ICT administrators. It has everything they need. Otherwise, ask an ICT administrator or instructor from your educational or research institution to [contact us](../getting-started/#contact-us) so we can give all user accounts from your institution access to Dodona. This service is free of charge.
:::
